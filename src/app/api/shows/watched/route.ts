...
// Mark a single show as watched and return one replacement
...
// Get watched shows for a member
export async function GET(req: NextRequest) {
  ...
  const rows = await db.execute({
    sql: "SELECT * FROM watched_movies WHERE member_id = ? AND content_type = 'show' ORDER BY watched_at DESC",
    args: [memberId],
  });
