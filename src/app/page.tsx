...
export default function Home() {
  ...
  if (!session) {
    return (
      <main className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-purple-950 text-white flex flex-col items-center justify-center px-4">
        <div className="text-center max-w-lg">
          ...
          <p className="text-xl text-gray-300 mb-2">
            AI movie picks for the whole family — without the arguing.
          </p>
          <p className="text-gray-500 mb-8">
            No more scrolling, no more debates. Just the right movie for everyone.
          </p>
          <button
            onClick={() => signIn("google")}
            className="flex items-center gap-3 mx-auto bg-white text-gray-900 px-6 py-3 rounded-xl font-semibold text-lg hover:bg-gray-100 transition-colors shadow-lg"
          >
